...
public class ExceptionController {
    ...
    public ResponseVo handle401(ShiroException e) {
        return new ResponseVo(401, null, e.getMessage());
    }
    ...
    public ResponseVo handle401() {
        return new ResponseVo(401, null, "Unauthorized");
    }
    ...
    public ResponseVo globalException(HttpServletRequest request, Throwable ex) {
        return new ResponseVo(getStatus(request).value(), null, ex.getMessage());
    }
